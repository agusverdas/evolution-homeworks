...
import com.evolution.homework.typeclass.ImplicitsHomework.SuperVipCollections4s._
import com.evolution.homework.typeclass.ImplicitsHomework.SuperVipCollections4s.syntax._
import com.evolution.homework.typeclass.ImplicitsHomework.SuperVipCollections4s.MutableBoundedCache
import com.evolution.homework.typeclass.ImplicitsHomeworkSpec.TestValue
...
class ImplicitsHomeworkSpec extends AnyFreeSpec with Matchers {
  ...
  "Iterate2 instances provided" - {
    "for Map" in {
      assertCompiles(
        """import com.evolution.homework.typeclass.ImplicitsHomework.SuperVipCollections4s._
          |import com.evolution.homework.typeclass.ImplicitsHomework.SuperVipCollections4s.instances._
          |
  ...
  "Size score of collections" - {
    ...
    "Array" in {
      // The code looks so complicated that IDEA tells that it doesn't compile, IDK how to fix it
  ...
  "TwitCache" - {
    import com.evolution.homework.typeclass.ImplicitsHomework.MyTwitter._
