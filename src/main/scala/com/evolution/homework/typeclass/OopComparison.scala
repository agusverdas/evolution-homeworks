...
import com.evolution.homework.typeclass.Fp.{Jsonable, User}
import com.evolution.homework.typeclass.Summoner.Jsonable
...
object Fp extends App {
  ...
  object InstancesTask {
    ...
    implicit val intJsonable: Jsonable[Int] = i => Json(s"$i")
...
object TypeclassTask {
  ...
  implicit val hashString: HashCode[String] = s => s.hashCode
